...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Results for Model 1 for basic same--different. \newatticus{Lines correspond to different input dimensions. These models were provided random input representations.}}
  \label{fig:model1}
\end{figure}
...
\Figref{fig:model1:premack} shows the results of applying the model in \dasheg{eq:x2h-supp}{eq:h2y-supp} to the hierarchical same--different task. \newatticus{The lines correspond to different embedding dimensionalities.} The only change from that model is that the inputs have dimensionality $4m$, since the four distinct representations in task inputs are simply concatenated.
...
\Figref{fig:model3a} shows the results of applying the model in \dasheg{eq:x2h1-supp}{eq:h2y2-supp} to the hierarchical same--different task. \newatticus{The lines correspond to different embedding dimensionalities.}
